...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative bg-gradient-hero py-24 px-4 sm:px-6 lg:px-8 overflow-hidden mb-12 z-20">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-background relative z-10 mt-8">
      ...
      {/* Features Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/30 relative z-10 mt-8">
        <div className="max-w-7xl mx-auto">
      ...
      {/* CTA Section */}
      <section className="relative py-24 px-4 sm:px-6 lg:px-8 bg-gradient-primary overflow-hidden mt-8 z-10">
