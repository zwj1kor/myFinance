...
export default function BaseKPICard({
  ...
  return (
    <HoverCard openDelay={200}>
      <HoverCardTrigger asChild>
        <Card
          className={cn(
            ...
            "border-2 border-primary/30 animate-fade-in relative overflow-hidden rounded-3xl",
          ...
          <div className="space-y-4 relative z-10">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between text-sm">
                ...
                <span
                  className={cn(
                    "font-bold px-4 py-2 rounded-2xl border-2 transition-all duration-300 group-hover:scale-110",
                    variance >= 0
      ...
      <HoverCardContent
        className="w-80 p-5 glass-card border-2 border-neon animate-scale-in rounded-2xl shadow-2xl shadow-primary/30"
        side="bottom"
      >
        <div className="space-y-3">
