  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Back of card */}
        <div 
          className="absolute inset-0 rounded-2xl bg-gradient-to-br from-accent/30 via-card to-primary/30 border border-accent/40 shadow-xl shadow-accent/10 flex flex-col items-center justify-center p-5 overflow-hidden group-hover:shadow-2xl group-hover:shadow-accent/30 transition-shadow duration-300"
          style={{ 
        ...
        >
          ...
          <div className="px-5 py-3 rounded-lg bg-primary/20 border border-primary/40 relative z-10 group-hover:bg-primary/30 transition-colors">
